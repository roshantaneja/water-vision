...
<qgis version="2.18.25-Las Palmas" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{48052a94-2f68-4c87-be9b-f50c00f9e377}">
      <rule filter=" &quot;level&quot;  % 50 = 0" key="{14aedb1a-97d4-40ba-9434-4b3181c6d1d6}" symbol="0" label="primary 50m contour lines"/>
      <rule scalemaxdenom="250000" filter=" &quot;level&quot;  % 50 &lt;> 0" key="{25777e41-db14-4165-a2d8-a22eb0b41796}" symbol="1" scalemindenom="1" label="secondary contour lines"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="150,100,71,255"/>
  ...
  <labeling type="rule-based">
    <rules key="{72439763-3db8-49c7-9b9b-eaf0fb877da5}">
      <rule filter=" &quot;level&quot;  % 50 = 0" key="{a63496a9-621c-4c15-9831-9860b321a06f}">
        <settings>
          <text-style fontItalic="1" fontFamily="Ubuntu" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="150,100,71,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="10" fieldName="level" namedStyle="Italic" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <text-buffer bufferSize="0.6000000000000001" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="1" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="128"/>
          ...
          <rendering fontMinPixelSize="3" scaleMax="10000000" fontMaxPixelSize="10000" scaleMin="1" upsidedownLabels="0" limitNumLabels="1" obstacle="1" obstacleFactor="1" scaleVisibility="0" fontLimitPixelSize="0" mergeLines="0" obstacleType="0" labelPerPart="0" zIndex="0" maxNumLabels="2000" displayAll="0" minFeatureSize="30"/>
          <data-defined/>
        </settings>
      </rule>
    </rules>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="level"/>
    ...
    <property key="labeling/textColorB" value="38"/>
